...
const Footer = () => {
    return (
        <div>
            <footer className=' bg-[#101727] mt-16 py-12 px-6 md:px-12 lg:px-20'>
                <div className="footer text-[white] lg:footer-horizontal container items-center mx-auto py-6 p-10">
                    <div>
                        ...
                        <p className='w-70 font-light text-[#ffffffab]'>Premium digital tools for creators, professionals, and businesses. Work smarter with our suite of powerful tools.</p>           
                    </div>
